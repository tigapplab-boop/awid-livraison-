...
export function ProductCard({ product, onAdd, onRemove, quantityInCart, locale, animatingProduct }: ProductCardProps) {
          ...
          {quantityInCart > 0 && onRemove ? (
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="w-8 h-8 rounded-full flex items-center justify-center bg-stone-200 hover:bg-stone-300 text-stone-700 active:scale-90 transition-all duration-150 shadow-sm"
                aria-label={isRTL ? 'إزالة من السلة' : 'Retirer du panier'}
              >
              ...
              {/* Quantité */}
              <span className="text-sm font-bold text-stone-700 min-w-[20px] text-center">
                {quantityInCart}
              </span>
